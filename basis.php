...
<html lang="en" dir="ltr">
  ...
  <body>
    <div class="container">
      ...
      <div class="main">
        <ul>
          <li><a href="gerecht_toevoeg.php" class="toevoeg">Basistechniek toevoegen</a></li>
        </ul>
      </br>
    </br>
  </br>
  <hr>
        <?php
          ...
          $query = "SELECT * FROM `Gerechten` WHERE `soort` = 'basistechniek' ORDER BY datum DESC";
          ...
          if ($resultaat = mysqli_query($mysqli, $query))
          {
            ...
            {
              //kleine info om te zien wat het is. De titel geeft een detail pagina van het gerecht.
